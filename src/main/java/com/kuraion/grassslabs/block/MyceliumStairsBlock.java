...
public class MyceliumStairsBlock extends StairBlock {
    public MyceliumStairsBlock() {
        super(() -> (GrassslabsModBlocks.MYCELIUM_SLAB.get()).defaultBlockState(), Properties.copy(Blocks.MYCELIUM).sound(SoundType.GRAVEL).strength(0.5f, 0.5f).lightLevel(s -> 0).dynamicShape());
    }
